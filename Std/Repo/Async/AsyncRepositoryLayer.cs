...
namespace OregoFramework.Repo
{
    ...
    {
        private readonly HashSet<IOnBeginSessionAsyncListener> onBeginSessionListeners;

        private readonly HashSet<IOnEndSessionAsyncListener> onEndSessionAsyncListeners;

        protected AsyncRepositoryLayer()
        {
            this.onBeginSessionListeners = new HashSet<IOnBeginSessionAsyncListener>();
            this.onEndSessionAsyncListeners = new HashSet<IOnEndSessionAsyncListener>();
        }
        ...
        {
            var repositories = this.GetElements<IAsyncRepository>();
        ...
        public void AddOnBeginSessionListener(IOnBeginSessionAsyncListener listener)
        {
            this.onBeginSessionListeners.Add(listener);
        }

        public void RemoveOnBeginSessionListener(IOnBeginSessionAsyncListener listener)
        {
        ...
        public void AddOnEndSessionListener(IOnEndSessionAsyncListener listener)
        {
            this.onEndSessionAsyncListeners.Add(listener);
        }

        public void RemoveOnEndSessionListener(IOnEndSessionAsyncListener listener)
        {
