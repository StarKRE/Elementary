...
namespace OregoFramework.App
{
    ...
    /// </summary>
    public interface IApplication : ISingletonElement
    {
        /// <summary>
        ...
        T GetClientLayer<T>() where T : IClientLayer;
        ...
        /// <typeparam name="T">Type of layer.</typeparam>
        /// <returns>Layer reference.</returns>
        T GetDatabaseLayer<T>() where T : IDatabaseLayer;
        ...
        /// <typeparam name="T">Type of layer.</typeparam>
        /// <returns>Layer reference.</returns>
        T GetRepositoryLayer<T>() where T : IRepositoryLayer;
        ...
        /// <typeparam name="T">Type of layer.</typeparam>
        /// <returns>Layer reference.</returns>
        T GetInteractorLayer<T>() where T : IInteractorLayer;
    }
}