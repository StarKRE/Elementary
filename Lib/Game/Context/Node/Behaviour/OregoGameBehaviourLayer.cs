...
{
    public abstract class OregoGameBehaviourLayer : OregoGameBehaviour, IOregoGameNodeLayer
    {
        private readonly Dictionary<Type, IOregoGameNode> gameNodeMap;

        private readonly HashSet<IOregoGameNode> gameNodeSet;

        protected OregoGameBehaviourLayer()
        {
        ...
        public virtual void AddNode(IOregoGameNode gameNode)
        {
            ...
            gameNode.OnAttachGame(this.GetContext<IOregoGameContext>());
        }
