...
namespace OregoFramework.Domain
{
    ...
    /// </summary>
    public interface IOregoInteractorLayer : IOregoComponent
    {
        /// <summary>
        ...
        T GetInteractor<T>() where T : IOregoInteractor;
        ...
        IEnumerable<T> GetInteractors<T>() where T : IOregoInteractor;
    }
}