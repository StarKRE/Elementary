...
{
    public abstract class GameObjectManager<T> : AutoGameNode
    {
        ...
        protected virtual void OnPrepareGame(object sender, GameObjectManager<T> self)
        {
        }
        ...
        protected virtual void OnReadyGame(object sender, GameObjectManager<T> self)
        {
        }
        ...
        protected virtual void OnStartGame(object sender, GameObjectManager<T> self)
        {
        }
        ...
        protected virtual void OnPauseGame(object sender, GameObjectManager<T> self)
        {
        }
        ...
        protected virtual void OnResumeGame(object sender, GameObjectManager<T> self)
        {
        }
